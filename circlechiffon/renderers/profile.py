...
TEMPLATE_PATH = ASSETS_DIR / "profile_core" / "template.png"
FOOTER_HEIGHT = 27
...
def _load_core_base_image() -> Image.Image:
    try:
        with Image.open(TEMPLATE_PATH) as template:
            return template.convert("RGB").resize((CORE_CANVAS_WIDTH, CANVAS_HEIGHT_CORE))
